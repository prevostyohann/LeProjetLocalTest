 ...
 */
final class Version20250217131645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_C8A621B312469DE2 ON trader (category_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C8A621B312469DE2 ON trader');
    }
}
